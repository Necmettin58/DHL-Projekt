...
data "archive_file" "lambda1_code" {
  type        = "zip"
  source_file = "./python/orderlambda.py"  # Pfad zum Quelldatei
  output_path = "./python/orderlambda.zip" # Pfad, wohin das ZIP-Archiv komprimiert werden soll
}
data "archive_file" "lambda2_code" {
  type        = "zip"
  source_file = "./getdriver/index.py"  # Pfad zum Quelldatei
  output_path = "./getdriver/index.zip" # Pfad, wohin das ZIP-Archiv komprimiert werden soll
}